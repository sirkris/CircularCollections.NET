...
namespace Collections.Generic.CircularTests.Abstracts
{
    public abstract class CircleHeapTests : ICircleContainerTests
    {
        ...
        {
            ICircleHeap<char> circleHeap = TestSetup(Mocks.DataEmptySize1Mock);
        ...
        public void ContainsShouldReturnTrueIfIndexedElementIsPresent()
        {
            ...
            Assert.True(circleHeap.Contains(
                Mocks.Data26EntriesWithSize26Mock[16].Value, Mocks.Data26EntriesWithSize26Mock[16].Index));
        }
        ...
        public void ContainsShouldReturnTrueIfCombinedIndexedElementIsPresent()
        {
            ...
            Assert.True(circleHeap.Contains(new HeapEntry<char>(
                Mocks.Data26EntriesWithSize26Mock[16].Index,
                Mocks.Data26EntriesWithSize26Mock[16].Value)));
        }
