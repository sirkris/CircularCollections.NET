...
namespace Collections.Generic.CircularTests
{
    public class CircleMinHeapTests : CircleHeapTests
    {
        ...
        {
            ICircleHeap<char> circleHeap = new CircleMinHeap<char>(Mocks.Data1EntryWithSize2Mock);
            circleHeap.Push('0', 1);
        ...
        {
            ICircleHeap<char> circleHeap = new CircleMinHeap<char>(Mocks.Data2EntriesWithSize3Mock);
            circleHeap.Push('b', 8);
        ...
        {
            ICircleHeap<char> circleHeap = new CircleMinHeap<char>(Mocks.Data3EntriesWithSize3Mock);
        ...
        {
            ICircleHeap<char> circleHeap = new CircleMinHeap<char>(Mocks.DataEmptySize3Mock);
        ...
        {
            ICircleHeap<char> circleHeap = new CircleMinHeap<char>(Mocks.Data3EntriesWithSize5Mock);
            circleHeap.Merge(new CircleMinHeap<char>(Mocks.Data2EntriesWithSize3Mock));
